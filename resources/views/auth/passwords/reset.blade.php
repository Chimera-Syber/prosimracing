        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="login__form-row login__form-row_margin">
                ...
                <div class="login__form-input-container">
                    <input id="email" type="email" class="login__form-control @error('email') login_form-control-is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
            ...
            <div class="login__form-row login__form-row_margin">
                ...
                <div class="login__form-input-container">
                    <input id="password" type="password" class="login__form-control @error('password') login_form-control-is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="{{ __('Password new reset placeholder') }}">
            ...
            <div class="login__form-row login__form-row_margin">
                ...
                <div class="login__form-input-container">
                    <input id="password-confirm" type="password" class="login__form-control" name="password_confirmation" required autocomplete="new-password" placeholder="{{ __('Password new reset confirm placeholder') }}">
                </div>
            </div>
