...
@section('title', 'ProSimRacing - Контакты')
...
<h1 class="main-section__title main-section__title_tag-margin">Contacts Us</h1>
<div class="main-section__tag-description">Contacts Us</div>
